...
export default function Page() {
    return <main><Header /><HeroSection /><SolutionsSection /><MethodSection /><ProcessSection /><AboutSection /><ProjectSection /><FaqSection /><ContactSection /><Footer /><FloatingWhatsApp /></main>
}
